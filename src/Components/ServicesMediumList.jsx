...
const services = [
  ...
  {id: "2", icon: <GiBarefoot className="icon" />, title: "Rehabilitation", desc: "Lorem ipsum", list: ["Physical Therapy", "Occupation Therapy", "Speech Therapy", "Aquatic Therapy", "Wound Care", "Pediatric Rehabilitation"]},
  {id: "3", icon: <GiMedicinePills className="icon" />, title: "Cancer Treatment", desc: "Lorem ipsum", list: ["Chemotherapy", "Radiation Therapy", "Cancer Surgery", "Hormone Therapy", "Immunotherapy", "Targeted Therapy"]}
]
